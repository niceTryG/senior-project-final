...
def import_products():
    ...
    # 1) Detect Dad Excel (Реализация)
    # Dad file contains: число / модель / сони / нархи / сумма
    is_dad_excel = (
    ...
    if is_dad_excel:
        return _import_dad_sales_excel(df=df, factory_id=factory_id)

    # 2) Normal product import (keep your flexible mapping)
    col_map = {
