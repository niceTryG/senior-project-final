...
class ProductService:
    ...
    def sales_totals(self):
        ...
        yesterday_sales = Sale.query.filter(Sale.date == yesterday).all()

        last_week_sales = (
            Sale.query
            .filter(Sale.date >= last_monday, Sale.date <= last_sunday)
            .all()
        )
    ...
    def list_shop_stock(self, query: str | None = None, sort: str = "name_asc"):
        """
    ...
    def production_summary(self, date_from=None, date_to=None):
        """
