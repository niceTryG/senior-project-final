...
from .currency_service import get_usd_uzs_rate   # <-- IMPORT
...
class FabricService:
    ...
    def get_dashboard_stats(self):
        ...
        low_stock_count = sum(
            1 for f in fabrics if f.quantity < self.LOW_STOCK_THRESHOLD
        )
        ...
        # Safe call to CBU rate – don't crash dashboard if API is down
        usd_uzs_rate = None
        try:
